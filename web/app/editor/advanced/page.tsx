    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-900">
        <div className="text-center max-w-md">
          ...
          <a href="/dashboard" className="inline-block mt-6 px-6 py-2.5 bg-primary text-white font-semibold rounded-button hover:bg-primary-hover">
            Go to Dashboard
          </a>
        </div>
      </div>
    ...
    <div className="h-screen flex flex-col bg-slate-900">
      ...
      <header className="h-14 bg-slate-800 border-b border-slate-700 flex items-center justify-between px-4 flex-shrink-0">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="px-3 py-1.5 bg-primary text-white text-xs font-medium rounded-button hover:bg-primary-hover disabled:opacity-50 transition-colors"
          >
          ...
          >
            {isOptimizing ? "G AI Optimizing..." : "G AI Optimize"}
          </button>
          <button
      ...
      {error && (
        <div className="bg-red-900/50 border-b border-red-700 px-4 py-2 text-red-300 text-xs flex items-center justify-between">
          <span>{error}</span>
          <button onClick={() => setError("")} className="text-red-400 hover:text-red-200">G</button>
        </div>
      )}
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="w-72 bg-slate-800 border-r border-slate-700 overflow-y-auto flex-shrink-0 flex flex-col">
          ...
          <div className="p-4 mt-auto">
            ...
            >
              {isOptimizing ? "G AI Optimizing..." : "G AI Optimize with LLM"}
            </button>
